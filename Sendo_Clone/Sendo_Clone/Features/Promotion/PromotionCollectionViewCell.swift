...
class PromotionCollectionViewCell: BaseCollectionViewCell {
    ...
    fileprivate lazy var coverView: BaseView = {
        let view = BaseView()
        view.backgroundColor = UIColor.topBackground
        return view
    }()
    ...
    fileprivate lazy var collectionView: UICollectionView = {
        ...
        collectionView.registerReusableCell(PromotionCellCollectionViewCell.self)
    ...
    private func layoutCoverView() {
        ...
        coverView.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(Dimension.shared.normalHeightView)
...
extension PromotionCollectionViewCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: PromotionCellCollectionViewCell = collectionView.dequeueReusableCell(for: indexPath)
